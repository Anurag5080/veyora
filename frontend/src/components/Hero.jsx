...
export default function Hero() {
  return (
    <section className="relative bg-veyoraGreen text-white min-h-[600px] md:min-h-[680px] flex items-end overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1563720223185-11003d516935?q=80&w=1600"
        alt="Chauffeur beside luxury car"
        className="absolute inset-0 w-full h-full object-cover opacity-60"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-veyoraGreen via-veyoraGreen/70 to-transparent" />

      <div className="relative max-w-7xl mx-auto w-full px-6 pb-16 pt-20 flex flex-col md:flex-row justify-between items-end gap-10">
        <div className="max-w-xl">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <Link to="/fleet" className="border border-white/40 px-6 py-3 rounded hover:bg-white/10">
              Explore The Fleet
            </Link>
          </div>
        </div>

        <div className="hidden md:block text-right text-sm max-w-[180px]">
